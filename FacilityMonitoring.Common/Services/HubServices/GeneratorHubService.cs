...
namespace FacilityMonitoring.Common.Server.Services {
    public class GeneratorsHubService : IHubServicere {
        ...
        public GeneratorsHubService(ILogger<GeneratorHubService> logger, IHubContext<GeneratorHub, IGeneratorHub> monitorHub,FacilityContext context) {
            this._logger = logger;
        ...
        public async Task StartAsync(CancellationToken cancellationToken) {
            ...
            var generators= await this._context.GetAllGeneratorsAsync();
