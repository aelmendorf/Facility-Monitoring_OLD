...
namespace FacilityMonitoring.Common.Data.Context {
    public class FacilityContext:DbContext {
        ...
        public DbSet<MonitorBoxReading> GenericBoxReadings { get; set; }
        public DbSet<MonitorBoxAlert> GenericBoxAlerts { get; set; }
        public DbSet<H2GenReading> H2GenReadings { get; set; }
        public DbSet<TankScaleReading> AmmoniaControllerReadings { get; set; }
