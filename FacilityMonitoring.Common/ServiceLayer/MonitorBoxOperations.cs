...
namespace FacilityMonitoring.Common.Hardware {
    ...
    public class MonitorBoxController  {
        ...
        public MonitorBoxController(IHubContext<MonitorBoxHub, IMonitorBoxHub> monitorHub) {
        ...
        public async Task StartAsync() {
            ...
            await _monitorHub.Clients.All.SendMonitorBoxReading(this.GetData());
